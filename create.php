...
<body>
        ...
        <div class="form-container">
            ...
            <form action = "formHandler.php" method = "post">
                ...
                <input type="text"  name="predu" placeholder="Level of Education" required><br><br>
                
                <label for="enrollmentDate">Date of Enrollment:</label><br>
                <input type="date"  name="enrdate" required><br><br>
                
                <label for="currentStatus">Current Status:</label><br>
                <input type="text"  name="stat" placeholder="Active/Graduated"required><br>
                
                <label for="currentGrade">Current Grade:</label><br>
                <input type="text" name="grade" placeholder="CPA" required><br><br>
                ...
                <input type="text" name="elig" placeholder="Eligible/Not Eligible"required><br>
